...
namespace TerrorMod.Common.Utils
{
    public class NPCLists : NPCID
    {
        public static HashSet<int> SafeNPCs { get; private set; } = new HashSet<int>()
        {
            ...
            PlanterasHook, PlanterasTentacle, GolemFistLeft, GolemFistRight, GolemHead, GolemHeadFree, CultistDragonBody1, CultistDragonBody2, CultistDragonBody3, CultistDragonBody4, CultistDragonHead, CultistDragonTail
