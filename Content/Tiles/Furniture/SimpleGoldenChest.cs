...
public class SimpleGoldenChest : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ItemType<Items.Placeable.Furniture.SimpleGoldenChest>(), 1);
    ...
    public override bool RightClick(int i, int j)
    {
        ...
        else
        {
            if (isLocked)
            {
                ...
                int key = ItemType<SimpleGoldenKey>();
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        else
        {
            ...
            {
                player.cursorItemIconID = ItemType<Items.Placeable.Furniture.SimpleGoldenChest>();
                if (Main.tile[left, top].TileFrameX / 36 == 1)
                {
                    player.cursorItemIconID = ItemType<SimpleGoldenKey>();
                }
