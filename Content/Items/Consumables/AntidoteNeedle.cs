...
public class AntidoteNeedle : ModItem
{
    ...
    public override bool? UseItem(Player player)
    {
        if (player.whoAmI == Main.myPlayer)
        {
            ...
            player.AddBuff(BuffType<AntidoteBuff>(), duration); // Adding the buff here instead of via Item.buffType prevents QoL mods from doing the infinite buff nonsense :D
        }
        return true;
    }
