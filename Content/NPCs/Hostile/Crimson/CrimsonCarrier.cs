...
public class CrimsonCarrier : ModNPC
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        NPCID.Sets.SpecificDebuffImmunity[Type][BuffType<InfectedCrimson>()] = true;
    ...
    public override void AI()
    {
        ...
        if (AttackTimer == FIRE_RATE)
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, direction * 2, ProjectileType<CrimsonCarrierProj>(), NPC.damage / 3, 1f);
